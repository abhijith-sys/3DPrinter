...
export default function HeroArt() {
  return (
    <div className="relative w-full h-full min-h-[280px]">
      <svg
        className="absolute inset-0 w-full h-full text-outline-variant"
      ...
      >
        ...
        <rect width="100%" height="100%" fill="url(#hero-dots)" opacity="0.45" />
      ...
      <svg
        ...
        aria-hidden
      >
        <rect x="36" y="60" width="110" height="180" rx="40" stroke="#6b6b6b" strokeOpacity="0.4" strokeWidth="2" />
        <rect x="420" y="30" width="90" height="90" rx="28" stroke="#6b6b6b" strokeOpacity="0.4" strokeWidth="2" />
        <rect x="430" y="300" width="80" height="130" rx="28" stroke="#6b6b6b" strokeOpacity="0.4" strokeWidth="2" />
        <rect x="60" y="360" width="100" height="70" rx="28" stroke="#6b6b6b" strokeOpacity="0.4" strokeWidth="2" />
